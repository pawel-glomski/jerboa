...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        open_action = QAction(
            icon, "&Open...", self, shortcut=QKeySequence.StandardKey.Open, triggered=self.open
        )
        ...
        icon = QIcon.fromTheme(
            "media-playback-start.png", style.standardIcon(QStyle.StandardPixmap.SP_MediaPlay)
        )
        ...
        icon = QIcon.fromTheme(
            "media-playback-pause.png", style.standardIcon(QStyle.StandardPixmap.SP_MediaPause)
        )
        ...
        icon = QIcon.fromTheme(
            "media-playback-stop.png", style.standardIcon(QStyle.StandardPixmap.SP_MediaStop)
        )
