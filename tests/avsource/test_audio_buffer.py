...
# from jerboa.core.timeline import FragmentedTimeline, TMSection, RangeMappingResult
...
#             AudioBuffer.reformat(frame_audio, buffer.format), buffer.format.name, buffer.layout.name
#         )
#         frame.pts = 16000
