...
class TestCircularBufferInit:
    ...
    def test_init_should_create_empty_buffer_when_valid_args(
        self, shape: tuple, axis: int, dtype: np.dtype
    ):
...
class TestCircularBufferPut:
    ...
    def test_put_should_add_data_to_buffer_when_buffer_is_empty(
        self, buffer_args, elements_num: int
    ):
...
class TestCircularBufferPop:
    ...
    @pytest.mark.parametrize("buffer_creator", ALL_BUFFER_CREATORS)
    @pytest.mark.parametrize("buffer_args", VALID_BUFFER_CASES)
    def test_clear_should_remove_all_elements(
        self, buffer_creator: BufferCreator, buffer_args: BufferArgs
    ):
        buffer = buffer_creator(buffer_args)
    ...
    def test_getitem_should_raise_index_error_when_index_out_of_range(
        self, buffer_creator: BufferCreator, buffer_args: BufferArgs, idx_offset: int
    ):
        buffer = buffer_creator(buffer_args)
    ...
    def test_getitem_should_return_correct_element_when_valid_index(
        self, buffer_args: BufferArgs, idx: int
    ):
        buffer = create_empty_buffer(buffer_args)
